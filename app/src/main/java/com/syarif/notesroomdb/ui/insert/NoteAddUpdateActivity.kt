...
import com.syarif.notesroomdb.databinding.ActivityNoteAddUpdateBinding
import com.syarif.notesroomdb.helper.DateHelper
...
class NoteAddUpdateActivity : AppCompatActivity() {
    ...
    private fun showAlertDialog(type: Int) {
        ...
        if (isDialogCLose) {
            ...
            dialogTitle = getString(R.string.description)
        }
